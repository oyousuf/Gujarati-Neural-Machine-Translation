...
checkpoint = torch.load('./model_checkpoint.tar', map_location=torch.device('gpu'))
...
with open('/proj/uppmax2021-2-14/gujarati/test/newstest2019-guen-ref.en.sgm', 'r') as f:
    data = f.read()
...
source = []
with open('/proj/uppmax2021-2-14/gujarati/test/newstest2019-guen-src.gu.sgm', 'r') as f:
    data = f.read()
    soup = BeautifulSoup(data, 'lxml')
    seg_attrs = soup.findAll('seg')
